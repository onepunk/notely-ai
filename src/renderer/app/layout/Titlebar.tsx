...
export const Titlebar: React.FC<TitlebarProps> = ({
  ...
  // Show activate button only when license is not active
  const isLicenseActive = license.status === 'active' || license.status === 'expiring';
  const showActivateButton = !isLicenseActive;
          ...
          <Menu>
            ...
            <MenuPopover>
              <MenuList>
                ...
                <MenuItem onClick={() => navigate('/ai-features/system')}>AI Features</MenuItem>
