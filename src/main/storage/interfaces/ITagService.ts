...
export interface ITagService {
  ...
  /**
   * Create tag with specific ID (for sync operations)
   */
  createTagWithId(tag: Partial<TagRow>): Promise<void>;

  /**
   * Update tag from sync data
   */
  updateTagFromSync(tag: Partial<TagRow>): Promise<void>;

  /**
   * Soft delete a tag (sync operation)
   */
  ...
  /**
   * Get all note_tags for sync operations
   */
